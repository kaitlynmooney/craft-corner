...
db.once('open', async () => {
    ...
    const projects = await Project.insertMany([
        {
            name: 'Simple Scarf',
            materials: ['Appx 200-300 yds Yarn: Medium weight (worsted #4)','Crochet Hook: size 5mm', 'Scissors', 'Tapestry Needle'],
            ...
            craft: crafts[0]._id },
            {
                ...
                materials:['200-300yds Medium Weight Yarn', 'Knitting Needles, 8,, or 5mm', 'Scissors', 'Tapestry Needle'], 
            ...
            {
                name: 'Cabled Sweater',
                materials:['1200-2800yds Worsted or DK Weight Yarn', 'Knitting Needles, 8 or 5mm', 'Scissors','Cable Needles', 'Stitch Markers', 'Tapestry Needle'], 
            ...
            },
            {
                ...
                materials:['Canvas, 8x10in', 'Acrylic Paints:Whatever Colors you feel.', 'Paint Brushes(Do not forget a small detail brush)', 'Palette', 'Water Container','Rags', 'Apron or Old Clothes you do not mind getting dirty',], 
            ...
            },
            {
                ...
                materials:['Canvas, 16x20in', 'Oil Paints/Acrylic Paints:Whatever Colors you feel.', 'Paint Brushes(Do not forget a small detail brush)', 'Palette', 'Water Container', 'Easel(optional)','Rags', 'Apron or Old Clothes you do not mind getting dirty', 'Linseed Oil/Turpentine: To change paint consistency'], 
            ...
            },
            {
                ...
                materials:['Air Dry/Oven Bake Clay: 1-2lbs', 'Basic Sculpting Tools','Rolling Pins', 'Paints(optional)','Brushes(optional)'], 
            ...
            },
            {
                ...
                materials:['High-quality Clay: Stoneware or Porcelain:5-10lbs', 'Sculpting Tools','Armature Tools(optional)','Rolling Pins','Kiln Access(local pottery studios usually hold kiln time)', 'Glazes(optional)','Sponge'], 
            ...
            },
            {
                ...
                materials:['Beads', 'Elastic Cord', 'Crimp Beads/Bead Stops','Crimping Tool', 'Scissors', 'Clasps'], 
            ...
            },
            {
                ...
                materials:['Gemstone', 'Metal Sheet/Wire', 'Jewelry Tools', 'Soldering Supplies','Bezel/Setting Material','Polishing Supplies', 'Clasps'], 
            ...
            }, 
            {
                ...
                materials:['Stained Glass Sheets','Copper Foil','Glass Cutter', 'Breaking Pliers','Soldering Iron', 'Flux', 'Pliers/Tweezers', 'Safety Glasses/Gloves', 'Hangers'], 
            ...
            },
            {
                ...
                materials:['Stained Glass Sheets','Copper Foil','Glass Cutter', 'Breaking Pliers','Grozing Pliers','Soldering Iron', 'Frame/Reinforcement', 'Pliers/Tweezers', 'Safety Glasses/Gloves', ], 
            ...
            }, 
            {
                ...
                materials:['Basic Pottery Clay','Pottery Tools', 'Rolling Pin', 'Clay Smoothing Tools', 'Paints/Glazes', 'Kiln Access: Optional, but access can be found at local pottery studios'
                ], 
            ...
            }, 
            {
                ...
                materials:['High-Quality Pottery Clay', 'Pottery Wheel', 'Pottery Tools', 'Kiln Access', 'Glazes', 'Kiln Supports'
                ], 

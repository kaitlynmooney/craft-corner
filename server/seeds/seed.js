...
db.once("open", async () => {
  ...
  const projects = await Project.insertMany([
    ...
    },
    {
      ...
      Instructions: [
        "Choose Your Theme: Pick an event or moment that you want to highlight, such as a birthday, a trip to the beach, or a holiday celebration",
        "Select Your Photos: Choose 3-5 photos that best capture the theme. Crop them if needed to fit the layout.",
        "Create the Background: Choose a sheet of scrapbook paper as your background. If you’re using a plain sheet, consider adding a border or using punches to create decorative edges.",
        "Arrange the Photos: Lay out your photos on the background paper. Play around with different arrangements until you find a layout you like. Consider layering photos slightly or tilting them for a more dynamic look",
        "Add Embellishments: Use stickers, washi tape, or other embellishments to enhance the theme. For example, if your theme is a beach day, you might add stickers of seashells, waves, or sunshine.",
        "Journal Your Thoughts: Use your journaling pen to add a title, captions, or notes about the event. You can write directly on the background paper or on small pieces of paper that you attach to the page.",
        "Secure Everything: Once you’re happy with the layout, use adhesive to attach the photos and embellishments to the background. Be sure to press firmly to secure everything in place.",
        "Final Touches: Add any last-minute decorations or touches, like a date stamp or extra stickers.",
      ],
    ...
    },
    {
      ...
      instructions: [
        "1. Start with a Square Base: Begin by folding the paper diagonally in both directions to create an X crease. Then fold it in half horizontally and vertically to create a plus crease. Collapse the paper into a smaller square shape (known as a square base) by folding along the creases.",
        "2. Fold into a Kite Shape: With the open end of the square base facing you, fold the two edges of the top layer towards the center crease to form a kite shape. Flip the paper over and repeat on the other side.",
        "3.Create the Bird Base: Fold the top point of the kite down and crease it well, then unfold. Open up the bottom flap of the kite and fold it upwards along the existing creases to form a long, diamond-shaped bird base. Flip over and repeat on the other side.",
        "4. Form the Wings and Head: Fold the two bottom flaps upwards, which will later become the wings. To create the head, fold one of the top points down to make a small triangle. Crease well.",
        "5. Shape the Crane: Pull the wings slightly apart, then gently push down on the head to create the neck. Crease the neck and head to keep the shape in place. Finally, fold the wings down to complete your crane.",
        "6. Final Touches: Adjust the wings and tail to your liking, and you’ve completed your first origami crane!",
      ],
